...
class StudentFacilityController extends Controller
{
    /**
     * FIXED: Display a listing of facilities with search and filters
     */
    public function index(Request $request)
    {
        ...
        return view('student.facilities.index', compact(
            'facilities',
            'totalFacilities', 
            'availableFacilities', 
            'bookedFacilities'
        ...
        try {
            ...
            $formattedFacilities = $facilities->map(function ($facility) use ($now) {
                ...
                return [
                    ...
                    'view_url' => route('student.facilities.show', $facility->id),
                    'book_url' => route('student.reservations.create', ['facility_id' => $facility->id]),
                ];
            });
            ...
            \Log::error('Student facility ajax error: ' . $e->getMessage());
    ...
    public function show(Facility $facility)
    {
        ...
        return view('student.facilities.show', compact('facility'));
    }
