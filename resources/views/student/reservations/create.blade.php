    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-4">
            <div class="flex items-center justify-between text-white">
                ...
                <a href="{{ route('student.wallet.index') }}" class="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm transition">
                    View Wallet
                </a>
            </div>
        </div>
...
function reservationForm() {
    return {
        ...
        async checkAvailability() {
            ...
            try {
                const response = await fetch('/student/reservations/check-availability', {
                    method: 'POST',
                    headers: {
