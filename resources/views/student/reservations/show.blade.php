...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-6">
            <a href="{{ route('student.reservations.index') }}" class="hover:text-[#002147] transition-colors">
            ...
            <div class="bg-gray-50 px-8 py-4 border-t border-gray-200">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    @if($reservation->status === 'cancelled' && $reservation->canBeDeleted())
                        <form method="POST" action="{{ route('student.reservations.destroy', $reservation->id) }}" 
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow sticky top-6">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('student.facilities.show', $reservation->facility) }}" 
