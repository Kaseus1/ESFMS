            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="notes" 
                                      ...
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('notes', $reservation->notes) }}</textarea>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mt-4">
                        <h4 class="text-sm font-semibold text-blue-900 mb-2">Original Booking</h4>
            ...
            try {
                const response = await fetch('{{ route(auth()->user()->role . '.reservations.checkAvailability') }}', {
                    ...
                    body: JSON.stringify({
                        ...
                        reservation_id: this.reservationId // Exclude current reservation
                    })
                });
