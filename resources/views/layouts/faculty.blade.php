        ...
        <nav class="navbar">
            <div class="navbar-container">
                <a href="{{ route('faculty.dashboard') }}" class="navbar-brand">
                    ...
                    <div class="brand-text"><h1>CPAC ESFMS</h1><p class="hidden sm:block text-xs opacity-70">faculty Portal</p></div>
                </a>

                <div class="desktop-nav">
                    <a href="{{ route('faculty.dashboard') }}" class="nav-link {{ request()->routeIs('faculty.dashboard') ? 'active' : '' }}">Dashboard</a>
                    <a href="{{ route('faculty.facilities.index') }}" class="nav-link {{ request()->routeIs('faculty.facilities.*') ? 'active' : '' }}">Facilities</a>
                    <a href="{{ route('faculty.reservations.index') }}" class="nav-link {{ request()->routeIs('faculty.reservations.*') ? 'active' : '' }}">Reservations</a>
                    <a href="{{ route('faculty.wallet.index') }}" class="nav-link {{ request()->routeIs('faculty.wallet.*') ? 'active' : '' }}">Wallet</a>
                ...
                <div style="position: relative;">
                    ...
                    <div class="desktop-dropdown" x-show="menuOpen" @click.outside="menuOpen = false" x-transition x-cloak>
                        <div class="menu-header">
                            ...
                            <a href="{{ route('faculty.profile.edit') }}" class="block w-full py-2 border border-gray-300 rounded-lg text-sm font-bold text-gray-600 hover:bg-gray-50 mb-2">Manage Account</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile-menu-drawer" :class="{ 'open': menuOpen }">
            ...
            <div class="menu-content-wrapper h-full flex flex-col">
                <div class="menu-header">
                    ...
                    <a href="{{ route('faculty.profile.edit') }}" class="inline-block px-4 py-1.5 border border-gray-300 rounded-full text-xs font-bold text-gray-600 hover:bg-gray-50">Manage Account</a>
                </div>

                <div class="menu-grid">
                    <a href="{{ route('faculty.dashboard') }}" class="menu-item"><i class="fa-solid fa-house text-xl text-[#002366]"></i><span class="text-xs font-bold text-gray-700">Dashboard</span></a>
                    <a href="{{ route('faculty.facilities.index') }}" class="menu-item"><i class="fa-solid fa-building text-xl text-[#002366]"></i><span class="text-xs font-bold text-gray-700">Facilities</span></a>
                    <a href="{{ route('faculty.reservations.index') }}" class="menu-item"><i class="fa-solid fa-calendar-check text-xl text-[#002366]"></i><span class="text-xs font-bold text-gray-700">Reservations</span></a>
                    <a href="{{ route('faculty.wallet.index') }}" class="menu-item"><i class="fa-solid fa-wallet text-xl text-[#10B981]"></i><span class="text-xs font-bold text-gray-700">Wallet</span></a>
                </div>
