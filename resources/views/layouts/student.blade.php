...
<a href="{{ route('student.facilities.index') }}" 
class="nav-item {{ request()->routeIs('student.facilities.*') ? 'active' : '' }}">
<i class="fa-solid fa-building"></i>
<span>Facilities</span>
</a>
<a href="{{ route('student.reservations.index') }}" 
class="nav-item {{ request()->routeIs('student.reservations.*') ? 'active' : '' }}">
...
class="nav-item {{ request()->routeIs('student.wallet.*') ? 'active' : '' }}">
<i class="fa-solid fa-wallet"></i>
<span>Wallet</span>
<span style="background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 0.15rem 0.5rem; border-radius: 20px; font-size: 0.7rem; font-weight: 700;">
...
<div style="font-size: 0.875rem; color: #00285C; margin-top: 0.25rem;">{{ Auth::user()->email }}</div>
</div>
...
<li><a href="{{ route('guest.dashboard') }}"><i class="fa-solid fa-chevron-right"></i> Dashboard</a></li>
<li><a href="{{ route('guest.facilities.index') }}"><i class="fa-solid fa-chevron-right"></i> Browse Facilities</a></li>
<li><a href="{{ route('guest.reservations.index') }}"><i class="fa-solid fa-chevron-right"></i> My Reservations</a></li>
<li><a href="{{ route('guest.profile.edit') }}"><i class="fa-solid fa-chevron-right"></i> Profile Settings</a></li>
</ul>
</div>
<!-- Support -->
<div class="footer-section">
