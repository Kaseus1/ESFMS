...
<div class="user-profile-btn" @click.stop="userDropdown = !userDropdown">
    <div style="display:flex; align-items:center; gap:0.75rem;">
        ...
        <span class="user-role" style="display:block; font-size:0.75rem; opacity:0.8;">student Account</span>
        </div>
    </div>
...
<li><a href="{{ route('student.dashboard') }}"><i class="fa-solid fa-chevron-right"></i> Dashboard</a></li>
<li><a href="{{ route('student.facilities.index') }}"><i class="fa-solid fa-chevron-right"></i> Browse Facilities</a></li>
<li><a href="{{ route('student.reservations.index') }}"><i class="fa-solid fa-chevron-right"></i> My Reservations</a></li>
<li><a href="{{ route('student.profile.edit') }}"><i class="fa-solid fa-chevron-right"></i> Profile Settings</a></li>
</ul>
</div>
<div class="footer-section">
