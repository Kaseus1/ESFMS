...
class="nav-item {{ request()->routeIs('guest.dashboard') ? 'active' : '' }}">
<i class="fa-solid fa-house"></i>
<span>Dashboard</span>
</a>
<a href="{{ route('guest.facilities.index') }}" 
class="nav-item {{ request()->routeIs('guest.facilities.*') ? 'active' : '' }}">
<i class="fa-solid fa-building"></i>
<span>Facilities</span>
</a>
<a href="{{ route('guest.reservations.index') }}" 
class="nav-item {{ request()->routeIs('guest.reservations.*') ? 'active' : '' }}">
...
<!-- WALLET NAV ITEM - NEW -->
<a href="{{ route('guest.wallet.index') }}" 
class="nav-item {{ request()->routeIs('guest.wallet.*') ? 'active' : '' }}">
