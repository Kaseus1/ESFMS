            ...
            <form action="{{ route('reservations.store') }}" method="POST" id="bookingForm" @submit="validateForm">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex-1 h-1 mx-4 transition" :class="step >= 2 ? 'bg-blue-600' : 'bg-gray-300'"></div>
                        ...
                        <div class="flex-1 h-1 mx-4 transition" :class="step >= 3 ? 'bg-blue-600' : 'bg-gray-300'"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <template x-for="facility in filteredFacilities" :key="facility.id">
                            <div @click="selectFacility(facility)"
                                 :class="selectedFacility?.id === facility.id ? 'ring-2 ring-blue-500 border-blue-500' : 'border-gray-200'"
                ...
                <div x-show="step === 2" x-transition class="space-y-6">
                    ...
                    <div x-show="selectedFacility" class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                        <div class="flex items-center">
                    ...
                    <!-- Duration Display -->
                    <div x-show="bookingDate && startTime && endTime" class="bg-gray-50 rounded-lg p-4">
                ...
                <div x-show="step === 3" x-transition class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('event_name') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('participants') border-red-500 @enderror"
