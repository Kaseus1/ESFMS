...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow rounded-lg">
            ...
            <!-- Form -->
            <form action="{{ route('faculty.reservations.update', $reservation) }}" method="POST" class="p-6" x-data="reservationForm()" x-init="init()">
                @csrf
                @method('PUT')
...
function reservationForm() {
    return {
        ...
        async checkAvailability() {
            ...
            try {
                const response = await fetch('{{ route('faculty.reservations.checkAvailability') }}', {
                    method: 'POST',
                    headers: {
