...
<div class="container mx-auto px-4 py-8" x-data="facilityForm()" x-init="init()">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('faculty.facilities.update', $facility) }}" method="POST" enctype="multipart/form-data" @submit="handleSubmit">
                @csrf
                @method('PUT')
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium focus-within:outline-none">
                                        <span style="color: var(--color-royal-blue);">{{ $facility->image ? 'Upload new image' : 'Upload a file' }}</span>
                                        <input id="image" 
                                               name="image" 
                                               type="file" 
