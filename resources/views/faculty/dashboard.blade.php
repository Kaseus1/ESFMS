...
<div class="actions-grid">
    <a href="{{ route('faculty.facilities.index') }}" class="action-btn">
    ...
    <a href="{{ route('faculty.reservations.index') }}" class="action-btn">
        <div class="action-btn-header">
    ...
    <a href="{{ route('faculty.wallet.index') }}" class="action-btn">
        <div class="action-btn-header">
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="list-card">
            <div class="list-header">
                ...
                <a href="{{ route('faculty.reservations.index') }}" class="text-xs font-bold text-blue-600 hover:text-blue-800">View All</a>
            </div>
            
            <div class="max-h-[350px] overflow-y-auto custom-scrollbar">
                @forelse($upcomingReservations as $reservation)
                    <a href="{{ route('faculty.reservations.show', $reservation->id) }}" class="reservation-item group">
                ...
                @empty
                    <div class="p-8 text-center">
                        ...
                        <a href="{{ route('faculty.facilities.index') }}" class="text-xs text-blue-600 font-bold mt-1 inline-block">Book Now</a>
                    </div>
                @endforelse
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var events = [
        @foreach($calendarReservations ?? [] as $res)
        {
            ...
            url: '{{ route("faculty.reservations.show", $res->id) }}'
        },
        @endforeach
    ];
