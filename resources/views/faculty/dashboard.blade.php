...
<div class="actions-grid" style="margin-bottom: 2rem;">
    <a href="{{ route('faculty.facilities.index') }}" class="action-card">
    ...
    <a href="{{ route('faculty.reservations.index') }}" class="action-card">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1rem;">
    ...
    <a href="{{ route('faculty.wallet.index') }}" class="action-card">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1rem;">
        ...
        <div class="sidebar-section">
            ...
            @if($upcomingReservations && $upcomingReservations->count() > 0)
                <div class="upcoming-reservations-list">
                    @foreach($upcomingReservations as $reservation)
                        <a href="{{ route('faculty.reservations.show', $reservation) }}" class="reservation-card status-{{ $reservation->status }}" style="text-decoration: none;">
                            <!-- Date Badge -->
                ...
                <a href="{{ route('faculty.reservations.index') }}" class="view-all-reservations-btn">
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('faculty.facilities.index') }}" style="color: var(--color-royal-blue); font-weight: 600; text-decoration: none;">
                        Book a facility →
                    </a>
                </div>
            @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(info) {
            window.location.href = '{{ route("faculty.reservations.index") }}/' + info.event.id;
        },
