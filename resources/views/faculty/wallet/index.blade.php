            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="background: linear-gradient(135deg, #f8f9fa, #f1f5f9);">
                        <th style="padding: 1rem; text-align: left; font-size: 0.75rem; font-weight: 700; color: #6b7280; text-transform: uppercase;">Date</th>
                        <th style="padding: 1rem; text-align: left; font-size: 0.75rem; font-weight: 700; color: #6b7280; text-transform: uppercase;">Type</th>
                        <th style="padding: 1rem; text-align: left; font-size: 0.75rem; font-weight: 700; color: #6b7280; text-transform: uppercase;">Description</th>
                        <th style="padding: 1rem; text-align: right; font-size: 0.75rem; font-weight: 700; color: #6b7280; text-transform: uppercase;">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 1.25rem 1rem;">
                            ...
                            <div style="font-size: 0.75rem; color: #6b7280;">{{ $transaction->created_at->format('h:i A') }}</div>
                        </td>
                        <td style="padding: 1.25rem 1rem;">
                            @if($transaction->type === 'topup')
                                <span style="background: #d1fae5; color: #065f46; padding: 0.35rem 0.85rem; border-radius: 20px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase;">Top Up</span>
                            @elseif($transaction->type === 'deduction')
                                <span style="background: #fee2e2; color: #991b1b; padding: 0.35rem 0.85rem; border-radius: 20px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase;">Deduction</span>
                            @else
                                <span style="background: #dbeafe; color: #1e40af; padding: 0.35rem 0.85rem; border-radius: 20px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase;">Refund</span>
                            @endif
                        </td>
                        <td style="padding: 1.25rem 1rem; color: #333;">{{ $transaction->reference ?? 'N/A' }}</td>
                        <td style="padding: 1.25rem 1rem; text-align: right; font-weight: 800; font-size: 1.1rem; color: {{ $transaction->type === 'deduction' ? '#dc2626' : '#059669' }};">
