    ...
    <div class="relative z-10">
        ...
        <div class="mt-8 pt-6 border-t border-white/10">
            <p class="text-sm opacity-80">
                ...
                To top-up your wallet, please visit the CPAC Finance Office and provide your Faculty ID. You may also contact <span class="font-bold text-white">+63 (33) 320-0870</span>.
            </p>
        </div>
    </div>
</div>
