    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('guest.facilities.show', $facility) }}" 
        ...
        <div x-show="isSubmitting" x-cloak class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center">
            <div class="bg-white rounded-lg p-8 text-center max-w-sm shadow-2xl">
                <svg class="animate-spin h-16 w-16 text-[#002147] mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Updating Facility...</h3>
                <p class="text-sm text-gray-600">Please wait while we process your request</p>
                <p x-show="uploadProgress" x-text="uploadProgress" class="text-xs text-blue-600 mt-2"></p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('guest.facilities.update', $facility) }}" method="POST" enctype="multipart/form-data" @submit="handleSubmit">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4 pb-2 border-b flex items-center">
                        <svg class="w-6 h-6 mr-2 text-[#002147]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('name') border-red-500 @enderror"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4"
                                  maxlength="1000"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('description') border-red-500 @enderror"
                                  placeholder="Brief description of the facility, amenities, and features...">{{ old('description', $facility->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="type" 
                                    ...
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('type') border-red-500 @enderror"
                                    required>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('location') border-red-500 @enderror"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-[#002147] transition"
                             @dragover.prevent="isDragging = true"
                             @dragleave.prevent="isDragging = false"
                             @drop.prevent="handleDrop"
                             :class="{ 'border-[#002147] bg-blue-50': isDragging }">
                            <div class="space-y-1 text-center">
                                <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <div class="flex text-sm text-gray-600">
                                    <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-[#002147] hover:text-[#003366] focus-within:outline-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   min="1"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('capacity') border-red-500 @enderror"
                                   placeholder="e.g., 10">
                            @error('capacity')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   min="1"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('max_capacity') border-red-500 @enderror"
                                   placeholder="e.g., 50">
                            @error('max_capacity')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="time" 
                                   ...
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('opening_time') border-red-500 @enderror"
                                   required>
                            @error('opening_time')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="time" 
                                   ...
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002147] focus:border-transparent @error('closing_time') border-red-500 @enderror"
                                   required>
                            @error('closing_time')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t">
                    ...
                    <button type="submit" 
                            ...
                            class="px-6 py-2 bg-[#002147] hover:bg-[#003366] text-white rounded-lg transition flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>
                        <span x-text="isSubmitting ? 'Updating...' : 'Update Facility'"></span>
                    </button>
                </div>
            </form>
        </div>
...
function facilityForm() {
    return {
        formData: {
            ...
            description: '{{ old('description', $facility->description) }}',
            type: '{{ old('type', $facility->type) }}',
            location: '{{ old('location', $facility->location) }}',
            capacity: {{ old('capacity', $facility->capacity) ?? 'null' }},
            maxCapacity: {{ old('max_capacity', $facility->max_capacity) ?? 'null' }},
            openingTime: '{{ old('opening_time', $facility->opening_time ? \Carbon\Carbon::parse($facility->opening_time)->format('H:i') : '08:00') }}',
            closingTime: '{{ old('closing_time', $facility->closing_time ? \Carbon\Carbon::parse($facility->closing_time)->format('H:i') : '18:00') }}',
            isPublic: {{ old('is_public', $facility->is_public) ? 'true' : 'false' }}
        },
        imagePreview: null,
        imageSizeInfo: '',
        isCompressing: false,
        ...
        async compressImage(file) {
            ...
            try {
                ...
                this.imageSizeInfo = `<span class="text-yellow-600">⚠ Using original (${originalSizeMB}MB)</span>`;
            } finally {
