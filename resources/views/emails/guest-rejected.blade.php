<!-- ============================================ -->
<!-- 1. GUEST APPROVED EMAIL TEMPLATE -->
...
<!-- ============================================ -->
<!-- 2. GUEST REJECTED EMAIL TEMPLATE -->
<!-- File: resources/views/emails/guest-rejected.blade.php -->
<!-- ============================================ -->
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>Thank you for your interest in the CPAC Educational Services Facility Management System (ESFMS).</p>
            
            <div class="info-box">
                <p><strong>We regret to inform you that your guest account registration could not be approved at this time.</strong></p>
                
                @if($guest->rejection_reason)
                <p style="margin-top: 15px;"><strong>Reason:</strong> {{ $guest->rejection_reason }}</p>
                @endif
            </div>

            <p>If you believe this is an error or would like to discuss your application further, please don't hesitate to contact us.</p>

            <div class="contact-box">
                <p><strong>📞 Need to Reapply or Have Questions?</strong></p>
                <p>Please contact the CPAC administration office for more information or to submit a new application with additional details.</p>
            </div>

            <p style="font-size: 14px; color: #777; line-height: 1.8;">
                We appreciate your understanding and interest in using our facility management system.
            </p>
        </div>
